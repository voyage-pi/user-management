...
async def select_user_trip_stats(user_id: str):
    """
...
async def select_user_trips(user_id: str):
    """
...
async def select_shared_trips(user_id: str):
    """
...
async def select_last_shared_trip(user_id: str, other_user_id: str):
    """
